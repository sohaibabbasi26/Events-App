...
const Post = () => {
    ...
    return (
        ...
        <span className="reviews_comp_base">
            ...
            <PerfectScrollbar style={{ overflow: "scroll" }} className="reviews_tab_base">
                ...
                <span className="review_span">
                    ...
                    <span className="review_middle_bar">
                        ...
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo omnis odio earum accusamus inventore ipsa iusto explicabo rerum autem. Non eaque ipsa eum eveniet quae repellat eius exercitationem assumenda alias.
